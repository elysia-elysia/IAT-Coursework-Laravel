    ...
    <div class="row justify-content-center">
        <div class="col-md-12 ">
            ...
            <!-- display the success status -->
                ...
                @if(\Illuminate\Support\Facades\Session::has('basket')
                    && count(\Illuminate\Support\Facades\Session::get('basket')->items)>0)
                    <div class="card-body">
                                    ...
                                    @if(Auth::check() && (Auth::user()->role == 0))
                                        <td>
                                            <div class="row">
                                                <div class="col">
                                                    <form
                                                        action="{{action('OrderController@updateBasketQuantity', $book['item']['id'])}}"
                                                        method="post"> @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                ...
                                                <div class="col-md-auto">
                                                    <form
                                                        action="{{action('OrderController@removeFromBasket', $book['item']['id'])}}"
                                                        method="post"> @csrf
